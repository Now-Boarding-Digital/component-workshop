...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'heading-h1': ['var(--text-size-heading-h1)', { lineHeight: 'var(--text-lh-heading-h1)' }],
        'heading-h2': ['var(--text-size-heading-h2)', { lineHeight: 'var(--text-lh-heading-h2)' }],
        'heading-h3': ['var(--text-size-heading-h3)', { lineHeight: 'var(--text-lh-heading-h3)' }],
        'heading-h4': ['var(--text-size-heading-h4)', { lineHeight: 'var(--text-lh-heading-h4)' }],
        'heading-h5': ['var(--text-size-heading-h5)', { lineHeight: 'var(--text-lh-heading-h5)' }],
        'content-base':   ['var(--text-size-content-base)',   { lineHeight: 'var(--text-lh-content-base)' }],
        'content-small':  ['var(--text-size-content-small)',  { lineHeight: 'var(--text-lh-content-small)' }],
        'content-xsmall': ['var(--text-size-content-xsmall)', { lineHeight: 'var(--text-lh-content-xsmall)' }],
        'content-number': ['var(--text-size-content-number)', { lineHeight: 'var(--text-lh-content-number)' }],
      },
    },
  },
  plugins: [],
